            ...
            <div class="card-body">
                ...
                <div class="col-sm-12 d-flex justify-content-end align-items-center">
                    ...
                    <a href="{{ route('feedback.create') }}" id="" type="button"
                        class="btn btn-relief-primary mb-1">Create New</a>
    ...
    <script>
        $(document).ready(function() {
            $('#feebackTable').DataTable({
                searching: true,
                paging: true,
                lengthMenu: [5, 10, 25], // Set the available page length options
                pageLength: 10, // Set the initial number of rows per page
                order: [
                    [5, 'asc']
                ],
                language: {
                    search: 'Search:', // Change the search placeholder text
                    paginate: {
                        first: '&laquo;', // Change the "First" button text
                        last: '&raquo;', // Change the "Last" button text
                        previous: '&lsaquo;', // Change the "Previous" button text
                        next: '&rsaquo;' // Change the "Next" button text
                    }
                }
            });
